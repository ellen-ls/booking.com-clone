...
const Header = () => {
    ...
    return (
        <header className='bg-[#013894]'>
            <nav className='mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8'
                ...
                <div className='flex lg:flex-1'>
                    <Link href='/' className='-m-1.5 p-1.5'>
                        ...
                        <img className='h-12 w-auto' src='https://static1.squarespace.com/static/5bde0f00c3c16aa95581e2e2/62b4cb1add9d257dd43bb03d/62b653fedc7c895918d19b24/1656116254983/booking+logo+white.png?format=1500w' alt=''></img>
                    </Link>
                </div>
                ...
                <Popover.Group className='hidden lg:flex lg:gap-x-12'>
                    <Popover className='relative'>
                        ...
                        >
                            <Popover.Panel className='absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900'>
                                <div className='p-4'>
                                    {products.map((item) => (
                                        <div key={item.name}
                                            ...
                                            <div className='flex-auto'>
                                                <a href={item.href}
                                                    className='block front-semibold text-[#013894]'>
                                                    {item.name}
            ...
            overflow-y-auto bg-[#013894] px-6 py-6 sm:max-w-sm sm:right-1 sm:ring-gray-900/10'>
